...
function Header({placeholder}) {
    ...
    return (
        ...
        grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            <div onClick={() => router.push('/')} className="relative flex flex-center h-10 cursor-pointer my-auto">
                <Image
            ...
            <div className="flex items-center md:border-2 rounded-full py-2 text-sm placeholder-gray-600">
                 <input 
                    ...
                    className="md:shadow-sm flex-grow pl-5 bg-transparent outline-none" 
                    type="text" 
